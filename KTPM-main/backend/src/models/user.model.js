...
userSchema.virtual('avatarUrlVirtual').get(function() {
  if (this.avatarUrl) {
...
userSchema.virtual('coverImageUrlVirtual').get(function() {
...
userSchema.methods.getPublicProfile = function() {
  ...
  } else if (this.avatar && this.avatarType) {
  ...
  } else if (this.coverImage && this.coverImageType) {
